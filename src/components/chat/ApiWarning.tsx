...
export const ApiWarning: React.FC = () => {
  return (
    <Alert variant="default" className="m-4 border-purple-500 bg-purple-50 dark:bg-purple-950 dark:border-purple-800">
      ...
      <AlertDescription>
        <span className="font-semibold">NOVA AI Assistant</span> - Your voice-enabled AI companion. 
        Ask questions, chat naturally, or interact using your voice for a seamless experience.
      </AlertDescription>
    </Alert>
  );
};
